...
async function createTables() {
    try {
        ...
        // Migration: Ensure account_key column exists and is unique for existing tables
        try { await sql`ALTER TABLE dividend_data ADD COLUMN IF NOT EXISTS account_key TEXT`; } catch(e){}
        try { await sql`UPDATE dividend_data SET account_key = 'legacy' WHERE account_key IS NULL`; } catch(e){}
        ...
        try { await sql`UPDATE pie_allocations SET account_key = 'legacy' WHERE account_key IS NULL`; } catch(e){}
        ...
        try { await sql`UPDATE yield_history SET account_key = 'legacy' WHERE account_key IS NULL`; } catch(e){}
        ...
        try { await sql`UPDATE portfolio_data SET account_key = 'legacy' WHERE account_key IS NULL`; } catch(e){}
